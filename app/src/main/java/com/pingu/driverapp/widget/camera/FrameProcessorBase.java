...
package com.pingu.driverapp.widget.camera;
...
//                      : BitmapUtils.getBitmap(data, frameMetadata);
      InputImage image = InputImage.fromByteBuffer(processingFrame, processingFrameMetaData.width,processingFrameMetaData.height, processingFrameMetaData.rotation, InputImage.IMAGE_FORMAT_NV21 );
