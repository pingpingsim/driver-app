...
import com.pingu.driverapp.widget.barcodedetection.PreferenceUtils;
...
public class CameraSource {
    ...
    private void setPreviewAndPictureSize(Camera camera, Parameters parameters) throws IOException {
        ...
        CameraSizePair sizePair = null;//PreferenceUtils.getUserSpecifiedPreviewSize(context);
        if (sizePair == null) {
...
//     */
//    private void setRotationDelete(Camera camera, Parameters parameters) {
...
//    }
    ...
    private void setRotation(Camera camera, Camera.Parameters parameters) {
        ...
        if (cameraInfo.facing == CameraInfo.CAMERA_FACING_FRONT) {
            this.rotation = (cameraInfo.orientation + degrees) % 360;
            displayAngle = (360 - this.rotation) % 360; // compensate for it being mirrored
        } else { // back-facing
            this.rotation = (cameraInfo.orientation - degrees + 360) % 360;
            displayAngle = this.rotation;
        }
        ...
        Log.d(TAG, "RotationDegrees is: " + this.rotation);
